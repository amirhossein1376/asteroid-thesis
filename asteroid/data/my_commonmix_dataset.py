...
class MyCommonMix(Dataset):
    ...
    def __init__(
        self, base_dir, metadata_dir, part, task="sep_clean", sample_rate=16000, n_src=2, segment=3, return_id=False
    ):
    ...
    def __getitem__(self, idx):
        ...
        mixture_name = mixture_path.split("/")[-1].split(".")[0]
        spl_idxs = [m.start() for m in re.finditer('_common', mixture_name)]
        id1 = mixture_name[:spl_idxs[0]]
        id2 = mixture_name[spl_idxs[0]+1:]
